...
const BlobbyHill = () => {
    ...
    const x2 =  useTransform(scrollYProgress, [0.4,0.7], ['-100%', '-25%']);
    const y2 = useTransform(scrollYProgress, [0.7, 0.9], ['100%', '20%']);
    // 
    ...
    <div className="w-full h-screen absolute bottom-0 left-0 right-0 z-[11] ">
      ...
      <motion.div className="absolute bottom-0 left-0 -translate-x-1/4 translate-y-1/4 w-full" style={{ x:x2, y:y2}} >
        <svg
          id="Isolation_Mode"
          data-name="Isolation Mode"
          xmlns="http://www.w3.org/2000/svg"
